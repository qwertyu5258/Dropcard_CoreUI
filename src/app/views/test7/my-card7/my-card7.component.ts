...
@Component({
  selector: 'my-card7',
  templateUrl: './my-card7.component.html',
  styleUrls: ['./my-card7.component.scss']
})

export class MyCard7Component implements OnInit, OnDestroy {
  ...
  zIndexChange(event) {
    ...
    if (event.path[5] && event.path[5].tagName == 'MY-CARD7') {
      event.path[5].style.zIndex = ++this.favoriteDevicesService.zIndex
    } else if (event.path[6] && event.path[6].tagName == 'MY-CARD7') {
