...
@Component({
  selector: 'my-card3',
  templateUrl: './my-card3.component.html',
  styleUrls: ['./my-card3.component.scss']
})

export class MyCard3Component implements OnInit, OnDestroy {
  ...
  zIndexChange(event) {
    ...
    if (event.path[5] && event.path[5].tagName == 'MY-CARD3') {
      event.path[5].style.zIndex = this.favoriteDevicesService.zIndex++
    } else if (event.path[6] && event.path[6].tagName == 'MY-CARD3') {
