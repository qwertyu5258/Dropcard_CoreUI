...
@Component({
  selector: 'my-card5',
  templateUrl: './my-card5.component.html',
  styleUrls: ['./my-card5.component.scss']
})

export class MyCard5Component implements OnInit, OnDestroy {
  ...
  zIndexChange(event) {
    ...
    if (event.path[5] && event.path[5].tagName == 'MY-CARD5') {
      event.path[5].style.zIndex = this.favoriteDevicesService.zIndex++
    } else if (event.path[6] && event.path[6].tagName == 'MY-CARD5') {
