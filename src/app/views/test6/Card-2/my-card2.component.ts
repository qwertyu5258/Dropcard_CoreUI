...
@Component({
  selector: 'my-card2',
  templateUrl: './my-card2.component.html',
  styleUrls: ['./my-card2.component.scss']
})

export class MyCard2Component implements OnInit, OnDestroy {
  // resize
  width = 516;
  height = 290;
  oldX = 0;
  ...
  constructor(private elementRef: ElementRef, private daterangepickerConfig: DaterangepickerConfig, private influxService: InfluxService) {
